...
// Rule 50: The first word of the name of a class/struct will begin with an
// uppercase letter. Rule 45: All words in an identifier will be separated by
// the '_' character.
struct Heart_vector {
...
constexpr float64 square_value(float64 v) { return v * v; }

constexpr float64 sqrt_newton(float64 x, float64 current, float64 previous) {
  return (current == previous)
             ? current
             : sqrt_newton(x, 0.5 * (current + (x / current)), current);
}
...
constexpr Heart_vector normalize_constexpr(float64 x, float64 y, float64 z) {
  const float64 magnitude =
      sqrt_constexpr(square_value(x) + square_value(y) + square_value(z));
...
struct Standard_leads {
  ...
  inline static constexpr Heart_vector lead_i =
      normalize_constexpr(1.0, 0.0, 0.0);
  inline static constexpr Heart_vector lead_ii =
      normalize_constexpr(0.5, 0.86602540378443864676, 0.0);
  inline static constexpr Heart_vector lead_iii =
      normalize_constexpr(-0.5, 0.86602540378443864676, 0.0);
  inline static constexpr Heart_vector lead_avr =
      normalize_constexpr(-0.86602540378443864676, -0.5, 0.0);
  inline static constexpr Heart_vector lead_avl =
      normalize_constexpr(0.86602540378443864676, -0.5, 0.0);
  inline static constexpr Heart_vector lead_avf =
      normalize_constexpr(0.0, 1.0, 0.0);
  inline static constexpr Heart_vector lead_v1 =
      normalize_constexpr(-0.6, 0.0, 0.8);
  inline static constexpr Heart_vector lead_v2 =
      normalize_constexpr(-0.3, 0.0, 0.95);
  inline static constexpr Heart_vector lead_v3 =
      normalize_constexpr(0.0, 0.0, 1.0);
  inline static constexpr Heart_vector lead_v4 =
      normalize_constexpr(0.3, 0.0, 0.95);
  inline static constexpr Heart_vector lead_v5 =
      normalize_constexpr(0.6, 0.0, 0.8);
  inline static constexpr Heart_vector lead_v6 =
      normalize_constexpr(0.9, 0.0, 0.4);
};
